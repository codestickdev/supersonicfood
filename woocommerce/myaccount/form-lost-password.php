...
?>
<div class="lostPassPage">
	<h1 class="lostPassPage__heading"><?php _e('Password recovery', 'codestick'); ?></h1>
	<form method="post" class="lostPassPage__form woocommerce-ResetPassword lost_reset_password">
