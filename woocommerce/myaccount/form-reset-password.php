...
<div class="lostPassReset">
	<h2 class="lostPassReset__heading"><?php _e('Password recovery', 'codestick'); ?></h2>
	<form method="post" class="lostPassReset__form woocommerce-ResetPassword lost_reset_password">
